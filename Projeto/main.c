...
int main(){
  ...
  int Opcao_Entrada, Opcao_Cenario;//Declaração das variáveis que controlam qual o tipo de entrada e qual cenário
      printf("******************************************************************************\n");
      ...
      if(Opcao_Entrada == 1){//Se a entrada for o modo iterativo
          ...
          TipoVoo Voo;//Variável que receberá os voos a serem inserido
            printf("******************************************************************************\n");
